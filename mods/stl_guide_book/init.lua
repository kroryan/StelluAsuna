...
When the ship touches solid ground, press <b>Aux1</b> (normally E) to land and convert the vehicle back into map blocks. The player respawn point is updated when landing. Exit through the front of the ship, then inspect the tanks and repair the hull.
...
<b>Aux1</b> (normally E) — land or exit the ship. On solid ground it restores the ship to blocks; while airborne it performs a controlled exit.
